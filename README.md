...
Recommended execution order (because of FK constraints):

1. `user_mysql.sql`
2. `image_asset_mysql.sql`
3. `agency_account_mysql.sql`
4. `agency_admin_application_mysql.sql`
5. `travel_offer_mysql.sql`
